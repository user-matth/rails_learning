...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { active: @banner.active, description: @banner.description, image: @banner.image, name: @banner.name, order: @banner.order, resume: @banner.resume } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { active: @banner.active, description: @banner.description, image: @banner.image, name: @banner.name, order: @banner.order, resume: @banner.resume } }
